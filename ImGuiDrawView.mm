...
Attach();
   ...
   char* Gnam = (char*) [[NSString stringWithFormat:nssoxorany("Device Ware"), ver] cStringUsingEncoding:NSUTF8StringEncoding];
...
ImGui::SeparatorText(oxorany("Criador:"));
ImGui::TextDisabled(oxorany("Device Ware"));
ImGui::Spacing();
ImGui::EndTabItem();
}
